...
namespace BooksEshop.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
		...
		public IActionResult SummaryPOST()
		{
			...
			if (applicationUser.CompanyId.GetValueOrDefault() == 0)
			{
				//Regular customer user, capture payment by stripe
				var options = new SessionCreateOptions
				{
					SuccessUrl = $"https://localhost:7050/customer/cart/OrderConfirmation?id={ShoppingCartVM.OrderHeader.Id}",
                    CancelUrl = "https://localhost:7050/customer/cart/index",
